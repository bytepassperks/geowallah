  ...
  <div class="container">
    ...
    <div class="block" data-reveal style="max-width:760px;margin:30px auto 0">
      ...
      <div style="margin:14px 0 22px">
        <iframe src="https://api.geowallah.com/embed?url=geowallah.com" title="AI Visibility Score" style="border:0;width:280px;height:118px;border-radius:14px;box-shadow:0 4px 20px rgba(0,0,0,.12)" loading="lazy"></iframe>
      </div>
